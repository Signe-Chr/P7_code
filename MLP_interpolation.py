...
def train_model(model, data, optimizer, device, wav):
    ...
    for index in tqdm(indeces_train):
        ...
        lambda_1,lambda_2,lambda_3,lambda_4=1/0.245, 1/0.991, 1/28.550, 1/24.264 #1,1,1,11/0.256, 1/0.972, 1/29.131, 1/21.684#1,1,1,1 1/2.970,1/1.032,1/11.495,1/24.648
